...
@Component({
  selector: 'app-client-history-upcoming',
  templateUrl: './client-history-upcoming.component.html',
  styleUrls: ['./client-history-upcoming.component.css']
})
export class ClientHistoryUpcomingComponent implements OnInit {
  id: any;
  details: any;
