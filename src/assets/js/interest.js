// $(".interest_check").hide(), $("#photography").change(function () { $(this).is(":checked") ? ($("label[for='photography']").removeClass("img_overlay"), $("div[aria-label='photography']").show()) : ($("label[for='photography']").addClass("img_overlay"), $(".interest_check").hide()) }), $("#culture").change(function () { $(this).is(":checked") ? ($("label[for='culture']").removeClass("img_overlay"), $("div[aria-label='culture'").show()) : ($("label[for='culture']").addClass("img_overlay"), $("div[aria-label='culture'").hide()) }), $("#cars").change(function () { $(this).is(":checked") ? ($("label[for='cars']").removeClass("img_overlay"), $("div[aria-label='cars'").show()) : ($("label[for='cars']").addClass("img_overlay"), $("div[aria-label='cars'").hide()) }), $("#fnd").change(function () { $(this).is(":checked") ? ($("label[for='fnd']").removeClass("img_overlay"), $("div[aria-label='fnd'").show()) : ($("label[for='fnd']").addClass("img_overlay"), $("div[aria-label='fnd'").hide()) }), $("#travel").change(function () { $(this).is(":checked") ? ($("label[for='travel']").removeClass("img_overlay"), $("div[aria-label='travel'").show()) : ($("label[for='travel']").addClass("img_overlay"), $("div[aria-label='travel'").hide()) }), $("#art").change(function () { $(this).is(":checked") ? ($("label[for='art']").removeClass("img_overlay"), $("div[aria-label='art'").show()) : ($("label[for='art']").addClass("img_overlay"), $("div[aria-label='art'").hide()) }), $("#books").change(function () { $(this).is(":checked") ? ($("label[for='books']").removeClass("img_overlay"), $("div[aria-label='books'").show()) : ($("label[for='books']").addClass("img_overlay"), $("div[aria-label='books'").hide()) }), $("#beauty").change(function () { $(this).is(":checked") ? ($("label[for='beauty']").removeClass("img_overlay"), $("div[aria-label='beauty'").show()) : ($("label[for='beauty']").addClass("img_overlay"), $("div[aria-label='beauty'").hide()) }), $("#technology").change(function () { $(this).is(":checked") ? ($("label[for='technology']").removeClass("img_overlay"), $("div[aria-label='technology'").show()) : ($("label[for='technology']").addClass("img_overlay"), $("div[aria-label='technology'").hide()) }), $("#music").change(function () { $(this).is(":checked") ? ($("label[for='music']").removeClass("img_overlay"), $("div[aria-label='music'").show()) : ($("label[for='music']").addClass("img_overlay"), $("div[aria-label='music'").hide()) }), $("#sports").change(function () { $(this).is(":checked") ? ($("label[for='sports']").removeClass("img_overlay"), $("div[aria-label='sports'").show()) : ($("label[for='sports']").addClass("img_overlay"), $("div[aria-label='sports'").hide()) }), $("#gaming").change(function () { $(this).is(":checked") ? ($("label[for='gaming']").removeClass("img_overlay"), $("div[aria-label='gaming'").show()) : ($("label[for='gaming']").addClass("img_overlay"), $("div[aria-label='gaming'").hide()) });
